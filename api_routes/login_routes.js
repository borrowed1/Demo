    ...
    Account.findByEmail(req.body.email, function(err, account){
        ...
        Account.register(new Account({
            ...
            transporter.sendMail({
                ...
                text: "Hello "+req.body.username+' and welcome to Sakura Girl Academy!\nYour account has been registrated, but you need to activate it by following this link :\n'+actUrl+'\n\nEnjoy!\n\t--',
                html: "Hello "+req.body.username+' and welcome to Sakura Girl Academy!<br>Your account has been registrated, but you need to activate it by clicking on the following link : <br><a href="'+actUrl+'">'+actUrl+'</a><br>Enjoy!<br>-- Nelderson'
            });
